...
> [!IMPORTANT]
> Prompts remain in their original language for reproducibility. Titles and descriptions use localized translations when available.
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `footwear` | `multi-platform-campaign` |

- **Plataformas:** Amazon Fashion, TikTok Shop, Pinterest
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
...
### 2. Trekking Tent Weather Triptych
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `outdoor-gear` | `weather-performance` |

- **Plataformas:** Outdoor Retail, Amazon, Pinterest
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `watches` | `collector-campaign` |

- **Plataformas:** Chrono24, Tmall Luxury, Instagram Shop
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `bags-and-accessories` | `luxury-fashion-campaign` |

- **Plataformas:** Farfetch, TikTok Shop, Pinterest
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `beauty` | `product-hero` |

- **Plataformas:** Shopify, Tmall, Instagram Shop, Shopee
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `fashion` | `campaign-launch` |

- **Plataformas:** TikTok Shop, Instagram Shop, Shopify
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-20
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `consumer-electronics` | `feature-visual` |

- **Plataformas:** Amazon, Amazon A+, JD, Tmall
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-20
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `automotive-accessories` | `feature-demonstration` |

- **Plataformas:** Amazon, eBay, Tmall
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `bedding-and-textiles` | `textile-lifestyle` |

- **Plataformas:** Amazon Home, Shopify, Pinterest
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `cycling` | `performance-feature` |

- **Plataformas:** Amazon Sports, Decathlon, Instagram Shop
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `food-and-beverage` | `menu-hero` |

- **Plataformas:** DoorDash, Uber Eats, Deliveroo, Meituan
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-20
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `garden-and-planters` | `maker-to-interior` |

- **Plataformas:** Etsy, Wayfair, Pinterest
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `home-and-furniture` | `lifestyle-scene` |

- **Plataformas:** Wayfair, Pinterest, Shopify
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-20
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `jewelry` | `macro-product-hero` |

- **Plataformas:** Tmall Luxury, Shopify, Instagram Shop
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-20
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `kitchen-appliances` | `catalog-to-lifestyle` |

- **Plataformas:** Amazon, Shopify, Xiaohongshu
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `pet-supplies` | `product-and-lifestyle` |

- **Plataformas:** Chewy, Instagram Shop, Amazon
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `tea-and-grocery` | `packaging-and-ritual` |

- **Plataformas:** Amazon Grocery, Shopify, Xiaohongshu
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
...
| Autor | Fonte | Setor | Caso de utilização |
|---|---|---|---|
| CommercePrompt Atlas Studio | Criação original para este repositório | `toys-and-kids` | `handmade-product-story` |

- **Plataformas:** Etsy, Amazon, Pinterest
- **Idioma do prompt:** `en`
- **Licença:** CC-BY-4.0
- **Publicado:** 2026-07-21
