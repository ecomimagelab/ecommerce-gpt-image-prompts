...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `footwear` | `multi-platform-campaign` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `outdoor-gear` | `weather-performance` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `watches` | `collector-campaign` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `bags-and-accessories` | `luxury-fashion-campaign` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `beauty` | `product-hero` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `fashion` | `campaign-launch` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `consumer-electronics` | `feature-visual` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `automotive-accessories` | `feature-demonstration` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `bedding-and-textiles` | `textile-lifestyle` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `cycling` | `performance-feature` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `food-and-beverage` | `menu-hero` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `garden-and-planters` | `maker-to-interior` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `home-and-furniture` | `lifestyle-scene` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `jewelry` | `macro-product-hero` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `kitchen-appliances` | `catalog-to-lifestyle` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `pet-supplies` | `product-and-lifestyle` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `tea-and-grocery` | `packaging-and-ritual` |
...
| Autor | Fuente | Sector | Caso de uso |
|---|---|---|---|
| CommercePrompt Atlas Studio | Creación original para este repositorio | `toys-and-kids` | `handmade-product-story` |
