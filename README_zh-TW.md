...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `footwear` | `multi-platform-campaign` |

- **適用平台:** Amazon Fashion, TikTok Shop, Pinterest
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `outdoor-gear` | `weather-performance` |

- **適用平台:** Outdoor Retail, Amazon, Pinterest
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `watches` | `collector-campaign` |

- **適用平台:** Chrono24, Tmall Luxury, Instagram Shop
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `bags-and-accessories` | `luxury-fashion-campaign` |

- **適用平台:** Farfetch, TikTok Shop, Pinterest
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `beauty` | `product-hero` |

- **適用平台:** Shopify, Tmall, Instagram Shop, Shopee
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-20
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `fashion` | `campaign-launch` |

- **適用平台:** TikTok Shop, Instagram Shop, Shopify
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-20
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `consumer-electronics` | `feature-visual` |

- **適用平台:** Amazon, Amazon A+, JD, Tmall
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-20
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `automotive-accessories` | `feature-demonstration` |

- **適用平台:** Amazon, eBay, Tmall
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `bedding-and-textiles` | `textile-lifestyle` |

- **適用平台:** Amazon Home, Shopify, Pinterest
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `cycling` | `performance-feature` |

- **適用平台:** Amazon Sports, Decathlon, Instagram Shop
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `food-and-beverage` | `menu-hero` |

- **適用平台:** DoorDash, Uber Eats, Deliveroo, Meituan
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-20
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `garden-and-planters` | `maker-to-interior` |

- **適用平台:** Etsy, Wayfair, Pinterest
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `home-and-furniture` | `lifestyle-scene` |

- **適用平台:** Wayfair, Pinterest, Shopify
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-20
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `jewelry` | `macro-product-hero` |

- **適用平台:** Tmall Luxury, Shopify, Instagram Shop
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-20
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `kitchen-appliances` | `catalog-to-lifestyle` |

- **適用平台:** Amazon, Shopify, Xiaohongshu
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `pet-supplies` | `product-and-lifestyle` |

- **適用平台:** Chewy, Instagram Shop, Amazon
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `tea-and-grocery` | `packaging-and-ritual` |

- **適用平台:** Amazon Grocery, Shopify, Xiaohongshu
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
...
| 作者 | 來源 | 產業 | 使用場景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本倉庫原創內容 | `toys-and-kids` | `handmade-product-story` |

- **適用平台:** Etsy, Amazon, Pinterest
- **提示詞語言:** `en`
- **授權:** CC-BY-4.0
- **發布日期:** 2026-07-21
