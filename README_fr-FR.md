...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `footwear` | `multi-platform-campaign` |

- **Plateformes:** Amazon Fashion, TikTok Shop, Pinterest
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `outdoor-gear` | `weather-performance` |

- **Plateformes:** Outdoor Retail, Amazon, Pinterest
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `watches` | `collector-campaign` |

- **Plateformes:** Chrono24, Tmall Luxury, Instagram Shop
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `bags-and-accessories` | `luxury-fashion-campaign` |

- **Plateformes:** Farfetch, TikTok Shop, Pinterest
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `beauty` | `product-hero` |

- **Plateformes:** Shopify, Tmall, Instagram Shop, Shopee
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-20
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `fashion` | `campaign-launch` |

- **Plateformes:** TikTok Shop, Instagram Shop, Shopify
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-20
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `consumer-electronics` | `feature-visual` |

- **Plateformes:** Amazon, Amazon A+, JD, Tmall
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-20
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `automotive-accessories` | `feature-demonstration` |

- **Plateformes:** Amazon, eBay, Tmall
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `bedding-and-textiles` | `textile-lifestyle` |

- **Plateformes:** Amazon Home, Shopify, Pinterest
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `cycling` | `performance-feature` |

- **Plateformes:** Amazon Sports, Decathlon, Instagram Shop
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `food-and-beverage` | `menu-hero` |

- **Plateformes:** DoorDash, Uber Eats, Deliveroo, Meituan
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-20
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `garden-and-planters` | `maker-to-interior` |

- **Plateformes:** Etsy, Wayfair, Pinterest
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `home-and-furniture` | `lifestyle-scene` |

- **Plateformes:** Wayfair, Pinterest, Shopify
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-20
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `jewelry` | `macro-product-hero` |

- **Plateformes:** Tmall Luxury, Shopify, Instagram Shop
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-20
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `kitchen-appliances` | `catalog-to-lifestyle` |

- **Plateformes:** Amazon, Shopify, Xiaohongshu
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `pet-supplies` | `product-and-lifestyle` |

- **Plateformes:** Chewy, Instagram Shop, Amazon
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `tea-and-grocery` | `packaging-and-ritual` |

- **Plateformes:** Amazon Grocery, Shopify, Xiaohongshu
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
...
| Auteur | Source | Secteur | Cas d’usage |
|---|---|---|---|
| CommercePrompt Atlas Studio | Création originale pour ce dépôt | `toys-and-kids` | `handmade-product-story` |

- **Plateformes:** Etsy, Amazon, Pinterest
- **Langue du prompt:** `en`
- **Licence:** CC-BY-4.0
- **Publié:** 2026-07-21
