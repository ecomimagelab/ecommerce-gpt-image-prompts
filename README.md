...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `footwear` | `multi-platform-campaign` |

- **Platforms:** Amazon Fashion, TikTok Shop, Pinterest
- **Prompt language:** `en`
- **License:** CC-BY-4.0
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `outdoor-gear` | `weather-performance` |

- **Platforms:** Outdoor Retail, Amazon, Pinterest
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `watches` | `collector-campaign` |

- **Platforms:** Chrono24, Tmall Luxury, Instagram Shop
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `bags-and-accessories` | `luxury-fashion-campaign` |

- **Platforms:** Farfetch, TikTok Shop, Pinterest
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `beauty` | `product-hero` |

- **Platforms:** Shopify, Tmall, Instagram Shop, Shopee
- **Prompt language:** `en`
- **License:** CC-BY-4.0
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `fashion` | `campaign-launch` |

- **Platforms:** TikTok Shop, Instagram Shop, Shopify
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-20
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `consumer-electronics` | `feature-visual` |

- **Platforms:** Amazon, Amazon A+, JD, Tmall
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-20
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `automotive-accessories` | `feature-demonstration` |

- **Platforms:** Amazon, eBay, Tmall
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `bedding-and-textiles` | `textile-lifestyle` |

- **Platforms:** Amazon Home, Shopify, Pinterest
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `cycling` | `performance-feature` |

- **Platforms:** Amazon Sports, Decathlon, Instagram Shop
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `food-and-beverage` | `menu-hero` |

- **Platforms:** DoorDash, Uber Eats, Deliveroo, Meituan
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-20
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `garden-and-planters` | `maker-to-interior` |

- **Platforms:** Etsy, Wayfair, Pinterest
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `home-and-furniture` | `lifestyle-scene` |

- **Platforms:** Wayfair, Pinterest, Shopify
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-20
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `jewelry` | `macro-product-hero` |

- **Platforms:** Tmall Luxury, Shopify, Instagram Shop
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-20
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `kitchen-appliances` | `catalog-to-lifestyle` |

- **Platforms:** Amazon, Shopify, Xiaohongshu
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `pet-supplies` | `product-and-lifestyle` |

- **Platforms:** Chewy, Instagram Shop, Amazon
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `tea-and-grocery` | `packaging-and-ritual` |

- **Platforms:** Amazon Grocery, Shopify, Xiaohongshu
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
...
| Author | Source | Industry | Use case |
|---|---|---|---|
| CommercePrompt Atlas Studio | Original creation for this repository | `toys-and-kids` | `handmade-product-story` |

- **Platforms:** Etsy, Amazon, Pinterest
- **Prompt language:** `en`
- **License:** CC-BY-4.0
- **Published:** 2026-07-21
