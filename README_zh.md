...
<h1 align="center">电商 GPT Image 2 提示词大全</h1>

<p align="center">面向全球电商的高质量、多语言 GPT Image 2 提示词库。</p>

<p align="center"><img src="assets/cover.png" width="100%" alt="电商 GPT Image 2 提示词大全"></p>
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `footwear` | `multi-platform-campaign` |

- **适用平台:** Amazon Fashion, TikTok Shop, Pinterest
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `outdoor-gear` | `weather-performance` |

- **适用平台:** Outdoor Retail, Amazon, Pinterest
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `watches` | `collector-campaign` |

- **适用平台:** Chrono24, Tmall Luxury, Instagram Shop
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `bags-and-accessories` | `luxury-fashion-campaign` |

- **适用平台:** Farfetch, TikTok Shop, Pinterest
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `beauty` | `product-hero` |

- **适用平台:** Shopify, Tmall, Instagram Shop, Shopee
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-20
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `fashion` | `campaign-launch` |

- **适用平台:** TikTok Shop, Instagram Shop, Shopify
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-20
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `consumer-electronics` | `feature-visual` |

- **适用平台:** Amazon, Amazon A+, JD, Tmall
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-20
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `automotive-accessories` | `feature-demonstration` |

- **适用平台:** Amazon, eBay, Tmall
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `bedding-and-textiles` | `textile-lifestyle` |

- **适用平台:** Amazon Home, Shopify, Pinterest
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `cycling` | `performance-feature` |

- **适用平台:** Amazon Sports, Decathlon, Instagram Shop
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `food-and-beverage` | `menu-hero` |

- **适用平台:** DoorDash, Uber Eats, Deliveroo, Meituan
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-20
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `garden-and-planters` | `maker-to-interior` |

- **适用平台:** Etsy, Wayfair, Pinterest
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `home-and-furniture` | `lifestyle-scene` |

- **适用平台:** Wayfair, Pinterest, Shopify
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-20
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `jewelry` | `macro-product-hero` |

- **适用平台:** Tmall Luxury, Shopify, Instagram Shop
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-20
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `kitchen-appliances` | `catalog-to-lifestyle` |

- **适用平台:** Amazon, Shopify, Xiaohongshu
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `pet-supplies` | `product-and-lifestyle` |

- **适用平台:** Chewy, Instagram Shop, Amazon
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `tea-and-grocery` | `packaging-and-ritual` |

- **适用平台:** Amazon Grocery, Shopify, Xiaohongshu
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
| 作者 | 来源 | 行业 | 使用场景 |
|---|---|---|---|
| CommercePrompt Atlas Studio | 本仓库原创内容 | `toys-and-kids` | `handmade-product-story` |

- **适用平台:** Etsy, Amazon, Pinterest
- **提示词语言:** `en`
- **许可证:** CC-BY-4.0
- **发布日期:** 2026-07-21
...
请通过 GitHub Issue 表单投稿。维护者会审核署名、版权、质量、可复现性和安全性，通过后添加 `approved` 标签。
